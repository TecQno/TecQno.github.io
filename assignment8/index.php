...
<body onload="initialize();">
    <h1><center>Post a picture</center></h1>
	<div class="container">    
		<div class="row">
			<div id="formParent" class="col-md-6 col-md-offset-3">
				<form id="form" class="form-horizontal" method="POST" action="postcard.php" enctype="multipart/form-data">
                    <div class="form-group">
                        <input type="hidden" id= "hiddenfilter" name="hiddenfilter" value= "123">
                    ...
                    <div class="form-group">
                        ...
                        <div class="checkbox-inline">
                            <label for="original">Sepia</label>
                            <input type="radio" name="filter" id="sepia" value="sepia" onclick="applySepiaFilter();">
                        </div>
                         <div class="checkbox-inline">
                            <label for="original">Hue</label>
                            <input type="radio" name="filter" id="hue" value="hue" onclick="applyHueFilter();">
                        </div>
                         <div class="checkbox-inline">
